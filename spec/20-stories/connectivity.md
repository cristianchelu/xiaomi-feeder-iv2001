...
- **Bowl weight** — presented food grams in the bowl now (plain string with one
  decimal place on `.../bowl_weight`, e.g. `42.3`; drift-stable between feeding
  events — see [auto-tare.md](../30-processes/auto-tare.md)).

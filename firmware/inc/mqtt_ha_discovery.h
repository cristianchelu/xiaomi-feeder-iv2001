...
int mqtt_ha_format_bowl_weight_config(char *buf,
                                      size_t len,
                                      const char *device_id);
...
int mqtt_ha_format_device_timezone_config(char *buf,
                                          size_t len,
                                          const char *device_id);
...
int mqtt_ha_format_weight_compensation_config(char *buf,
                                              size_t len,
                                              const char *device_id);

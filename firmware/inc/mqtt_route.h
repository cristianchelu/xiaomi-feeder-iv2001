...
typedef enum {
    ...
    MQTT_ROUTE_CMD_SCHEDULE_TOGGLE,
    MQTT_ROUTE_CMD_SCHEDULE_SKIP,
    MQTT_ROUTE_CMD_SCHEDULE_ENABLE,
    MQTT_ROUTE_CMD_SCHEDULE_TODAY,
    MQTT_ROUTE_CMD_CALIBRATE,
    MQTT_ROUTE_CMD_DISPLAY,
    MQTT_ROUTE_CMD_CONFIG,
    MQTT_ROUTE_CMD_FEED_MODE,
    MQTT_ROUTE_CMD_FEED_OVERFILL,
